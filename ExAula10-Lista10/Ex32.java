...
public class Ex32 {
    ...
    static void exibirPosOrdenado(No32 atual) {
        if (atual != null) {
            exibirPosOrdenado(atual.esq);
            exibirPosOrdenado(atual.dir);
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Apresentacao (Pós-Ordenado): ");
        exibirPosOrdenado(raiz);
        System.out.println();
        leitor.close();
    }
}